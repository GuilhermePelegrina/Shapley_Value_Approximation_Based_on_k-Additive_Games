...
#samples,error_all_k1, error_all_k2, error_all_k3, error_all_k4, index_k1, index_k2, index_k3, index_k4 = np.load('results_kAddApprox_wine_rf.npy', allow_pickle=True)
